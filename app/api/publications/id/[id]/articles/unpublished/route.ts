...
export async function GET(
    ...
    try {
        ...
        if (!pub) {
            return NextResponse.json({ articles: null, error: 'Publication not found' }, { status: 404 })
        }
        ...
        return NextResponse.json({ articles: null, error: 'Internal server error' }, { status: 500 })
    }
}
