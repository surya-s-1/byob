...
export async function GET(
    ...
    try {
        ...
        if (!pub) {
            return NextResponse.json({ series: null, pagination: null, error: 'Publication not found' }, { status: 404 })
        }
        ...
        return NextResponse.json({ series: null, pagination: null, error: 'Internal server error' }, { status: 500 })
    }
}
