...
export async function GET(
    ...
    try {
        ...
        if (!collection) {
            return NextResponse.json({ collection: null, error: 'Collection not found' }, { status: 404 })
        }
        ...
        return NextResponse.json({ collection: null, error: 'Internal server error' }, { status: 500 })
    }
}
...
export async function PUT(
    ...
    try {
        ...
        if (!collection) {
            return NextResponse.json({ updated: false, error: 'Collection not found' }, { status: 404 })
        }
...
export async function DELETE(
    ...
    try {
        ...
        if (!collection) {
            return NextResponse.json({ deleted: false, error: 'Collection not found' }, { status: 404 })
        }
